...
const impl = {
  ...
  updatePurchaseEvent: (event, complete) => {
    ...
    if (constants.NAUGHTY && origin.indexOf(constants.NAUGHTY) > -1) {
      console.log(`${constants.METHOD_UPDATE_PURCHASE_EVENT} - event generated by ${constants.NAUGHTY}.  Skipping.`)
      complete()
    }
